...
func (c *notificationServiceClient) StreamNotifications(ctx context.Context, in *NotificationRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Notification], error) {
...
func (UnimplementedNotificationServiceServer) StreamNotifications(*NotificationRequest, grpc.ServerStreamingServer[Notification]) error {
...
func _NotificationService_StreamNotifications_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(NotificationServiceServer).StreamNotifications(m, &grpc.GenericServerStream[NotificationRequest, Notification]{ServerStream: stream})
}
