...
const file_proto_upload_proto_rawDesc = "" +
	"\n" +
	"\x12proto/upload.proto\x12\x06upload\"A\n" +
	"\tFileChunk\x12\x1a\n" +
	...
	"\x11FileUploadService\x123\n" +
	"\x06Upload\x12\x11.upload.FileChunk\x1a\x14.upload.UploadStatus(\x01B\x12Z\x10./proto/uploadpbb\x06proto3"
...
var file_proto_upload_proto_goTypes = []any{
	...
	(*UploadStatus)(nil), // 1: upload.UploadStatus
}
var file_proto_upload_proto_depIdxs = []int32{
	0, // 0: upload.FileUploadService.Upload:input_type -> upload.FileChunk
	1, // 1: upload.FileUploadService.Upload:output_type -> upload.UploadStatus
