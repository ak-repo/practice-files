...
const (
	FileUploadService_Upload_FullMethodName = "/upload.FileUploadService/Upload"
)
...
func (c *fileUploadServiceClient) Upload(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[FileChunk, UploadStatus], error) {
...
type FileUploadService_UploadClient = grpc.ClientStreamingClient[FileChunk, UploadStatus]
...
func (UnimplementedFileUploadServiceServer) Upload(grpc.ClientStreamingServer[FileChunk, UploadStatus]) error {
...
func _FileUploadService_Upload_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(FileUploadServiceServer).Upload(&grpc.GenericServerStream[FileChunk, UploadStatus]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type FileUploadService_UploadServer = grpc.ClientStreamingServer[FileChunk, UploadStatus]
